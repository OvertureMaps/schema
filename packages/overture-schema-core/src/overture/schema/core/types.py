...
LinearlyReferencedPosition = Annotated[
    float,
    Field(
        ge=0,
        le=1,
...
FeatureVersion = Annotated[int, Field(ge=0, description="")]
...
# the time.
FeatureUpdateTime = Annotated[
    ISO8601DateTime, Field(description="Timestamp when the feature was last updated")
]
