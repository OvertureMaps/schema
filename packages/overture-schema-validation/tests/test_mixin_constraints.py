...
class TestExactlyOneOfValidator:
    ...
    def test_exactly_one_of_validator_direct(self):
    ...
    def test_exactly_one_of_constraint_decorator(self):
    ...
    def test_exactly_one_of_multiple_fields(self):
    ...
    def test_exactly_one_of_json_schema(self):
