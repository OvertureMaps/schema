...
pytest.skip("Skipping the tests for opening hours", allow_module_level=True)

PlaceWithOperatingHours = create_model(
    "PlaceWithOperatingHours",
    __base__=Place,
    operating_hours=OperatingHours | None,
)

EntityWithOperatingHours = create_model(
...
def test_hourset_symbolic_close() -> None:
...
def test_hourset_multiple_days() -> None:
...
def test_hourset_overnight() -> None:
...
def test_hourset_validation_time_format() -> None:
...
def test_hourset_validation_invalid_hour() -> None:
...
def test_hourset_validation_invalid_minute() -> None:
...
def test_hourset_validation_24_hours_with_times() -> None:
...
def test_hourset_validation_24_hours_without_times() -> None:
...
def test_operating_hours_creation() -> None:
...
def test_operating_hours_required_field() -> None:
...
def test_entity_with_operating_hours_creation() -> None:
...
def test_entity_with_operating_hours_with_hours() -> None:
...
def test_entity_with_operating_hours_json_serialization() -> None:
...
def test_place_with_operating_hours_creation() -> None:
...
def test_place_with_operating_hours_with_hours() -> None:
...
def test_place_with_operating_hours_complex_schedule() -> None:
...
def test_place_with_operating_hours_json_serialization() -> None:
    """Test that PlaceWithOperatingHours can be serialized to JSON."""
    place = PlaceWithOperatingHours(
        id="jsohistn-test-001",
...
def test_example_nightclub() -> None:
...
def test_example_convenience_store() -> None:
...
def test_example_restaurant_varied_schedule() -> None:
...
def test_rule_validation_invalid_date() -> None:
...
def test_rule_validation_date_range() -> None:
...
def test_rule_validation_same_start_end_date() -> None:
...
def test_operating_hours_with_rules() -> None:
...
def test_example_store_with_holiday_hours() -> None:
...
def test_example_seasonal_cafe() -> None:
