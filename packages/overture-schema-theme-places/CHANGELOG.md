...
- Removed the deprecated `categories` field from `place` and standardized place categorization on `taxonomy`. ([#434](https://github.com/OvertureMaps/schema/issues/434))
