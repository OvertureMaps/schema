...
"""Division Boundary validation expression builders."""
...
def _division_ids_min_length_check() -> Check:
    return Check(
        field="division_ids_min_length",
        name="array_min_length",
...
def _division_ids_max_length_check() -> Check:
    return Check(
        field="division_ids_max_length",
...
def _division_ids_unique_check() -> Check:
    return Check(
        field="division_ids_unique",
        name="struct_unique",
...
def _division_ids_string_min_length_check() -> Check:
    return Check(
        field="division_ids[]",
        name="string_min_length",
...
def _division_ids_no_whitespace_check() -> Check:
    return Check(
        field="division_ids[]",
        name="no_whitespace",
        expr=array_check(
...
def _check_require_if_7_check() -> Check:
    return Check(
...
def _check_forbid_if_8_check() -> Check:
    return Check(
        field="country_forbidden",
        name="forbid_if",
...
def division_boundary_checks() -> list[Check]:
    """All validation checks for division_boundary."""
    return [
        _id_required_check(),
        ...
        _class_enum_check(),
        _division_ids_check(),
        _division_ids_min_length_check(),
        _division_ids_max_length_check(),
        _division_ids_unique_check(),
        _division_ids_string_min_length_check(),
        _division_ids_no_whitespace_check(),
        _country_check(),
        _region_check(),
        ...
        _check_require_if_7_check(),
        _check_forbid_if_8_check(),
    ]


DIVISION_BOUNDARY_SCHEMA = StructType(
    [
        ...
        StructField("division_ids", ArrayType(StringType(), True), True),
