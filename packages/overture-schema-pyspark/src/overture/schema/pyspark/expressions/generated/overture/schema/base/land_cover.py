...
"""Land Cover validation expression builders."""
...
def _type_enum_check() -> Check:
    return Check(
        field="type",
        name="enum",
        expr=check_enum(F.col("type"), ["land_cover"]),
        shape=CheckShape.SCALAR,
        read_columns=frozenset({"type"}),
    )
...
def land_cover_checks() -> list[Check]:
    """All validation checks for land_cover."""
    return [
        _id_required_check(),
...
ENTRY_POINT = "overture.schema.base:LandCover"

PARTITIONS: dict[str, str] = {"theme": "base"}

MODEL_VALIDATION = ModelValidation(
    schema=LAND_COVER_SCHEMA,
    checks=land_cover_checks,
