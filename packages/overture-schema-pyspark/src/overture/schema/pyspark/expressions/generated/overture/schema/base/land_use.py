...
"""Land Use validation expression builders."""
...
def _type_enum_check() -> Check:
    return Check(
        field="type",
        name="enum",
        expr=check_enum(F.col("type"), ["land_use"]),
        shape=CheckShape.SCALAR,
        read_columns=frozenset({"type"}),
    )
...
def land_use_checks() -> list[Check]:
    """All validation checks for land_use."""
    return [
        _id_required_check(),
...
ENTRY_POINT = "overture.schema.base:LandUse"

PARTITIONS: dict[str, str] = {"theme": "base"}

MODEL_VALIDATION = ModelValidation(
    schema=LAND_USE_SCHEMA,
    checks=land_use_checks,
