...
"""Building validation expression builders."""
...
def _type_enum_check() -> Check:
    return Check(
        field="type",
        name="enum",
        expr=check_enum(F.col("type"), ["building"]),
        shape=CheckShape.SCALAR,
        read_columns=frozenset({"type"}),
    )
...
def building_checks() -> list[Check]:
    """All validation checks for building."""
    return [
        _id_required_check(),
...
ENTRY_POINT = "overture.schema.buildings:Building"
