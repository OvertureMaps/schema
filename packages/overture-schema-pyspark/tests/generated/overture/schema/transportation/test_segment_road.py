...
BASE_ROW_POPULATED: dict = {
    ...
    "road_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}],
    "road_surface": [{"value": "unknown", "between": [0.0, 1.0]}],
    "speed_limits": [
        {
            "max_speed": {"value": 1, "unit": "mph"},
            "min_speed": {"value": 1, "unit": "mph"},
            "is_max_speed_variable": False,
            "between": [0.0, 1.0],
            "when": {
                "heading": "forward",
                "during": "",
    ...
    "subclass": "link",
    "width_rules": [{"value": 1.0, "between": [0.0, 1.0]}],
}
...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="segment::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="segment::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="segment::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="segment::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="segment::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="segment::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
    ...
    Scenario(
        id="segment::destinations[].from_connector_id:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].from_connector_id", None),
        expected_field="destinations[].from_connector_id",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].from_connector_id:string_min_length",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].from_connector_id", ""),
        expected_field="destinations[].from_connector_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::destinations[].from_connector_id:no_whitespace",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].from_connector_id", "has whitespace"),
        expected_field="destinations[].from_connector_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="segment::destinations[].to_connector_id:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_connector_id", None),
        expected_field="destinations[].to_connector_id",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].to_connector_id:string_min_length",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_connector_id", ""),
        expected_field="destinations[].to_connector_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::destinations[].to_connector_id:no_whitespace",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_connector_id", "has whitespace"),
        expected_field="destinations[].to_connector_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="segment::destinations[].to_segment_id:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_segment_id", None),
        expected_field="destinations[].to_segment_id",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].to_segment_id:string_min_length",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_segment_id", ""),
        expected_field="destinations[].to_segment_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::destinations[].to_segment_id:no_whitespace",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].to_segment_id", "has whitespace"),
        expected_field="destinations[].to_segment_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="segment::destinations[].final_heading:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].final_heading", None),
        expected_field="destinations[].final_heading",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].final_heading:enum",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].final_heading", "__INVALID__"),
        expected_field="destinations[].final_heading",
        expected_check="enum",
    ),
    Scenario(
        id="segment::destinations[].labels_min_length:array_min_length",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].labels", []),
        expected_field="destinations[].labels_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
    ...
    Scenario(
        ...
        mutate=set_at_path("destinations[].labels[].value", None),
        expected_field="destinations[].labels[].value",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].labels[].value:string_min_length",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].labels[].value", ""),
        expected_field="destinations[].labels[].value",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::destinations[].labels[].value:stripped",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].labels[].value", " has spaces "),
        expected_field="destinations[].labels[].value",
        expected_check="stripped",
    ),
    Scenario(
        id="segment::destinations[].labels[].type:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].labels[].type", None),
        expected_field="destinations[].labels[].type",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].labels[].type:enum",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].labels[].type", "__INVALID__"),
        expected_field="destinations[].labels[].type",
        expected_check="enum",
    ),
    Scenario(
    ...
    Scenario(
        ...
        mutate=set_at_path("destinations[].symbols[]", "__INVALID__"),
        expected_field="destinations[].symbols[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::destinations[].when.heading:required",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].when.heading", None),
        expected_field="destinations[].when.heading",
        expected_check="required",
    ),
    Scenario(
        id="segment::destinations[].when.heading:enum",
        scaffold={
            "destinations": [
                {
                    "from_connector_id": "a",
        ...
        mutate=set_at_path("destinations[].when.heading", "__INVALID__"),
        expected_field="destinations[].when.heading",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence:required",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].sequence", None),
        expected_field="prohibited_transitions[].sequence",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence_min_length:array_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
    ...
    Scenario(
        ...
        mutate=set_at_path("prohibited_transitions[].sequence[].connector_id", None),
        expected_field="prohibited_transitions[].sequence[].connector_id",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence[].connector_id:string_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].sequence[].connector_id", ""),
        expected_field="prohibited_transitions[].sequence[].connector_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence[].connector_id:no_whitespace",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path(
            "prohibited_transitions[].sequence[].connector_id", "has whitespace"
        ),
        expected_field="prohibited_transitions[].sequence[].connector_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence[].segment_id:required",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].sequence[].segment_id", None),
        expected_field="prohibited_transitions[].sequence[].segment_id",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence[].segment_id:string_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].sequence[].segment_id", ""),
        expected_field="prohibited_transitions[].sequence[].segment_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="segment::prohibited_transitions[].sequence[].segment_id:no_whitespace",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path(
            "prohibited_transitions[].sequence[].segment_id", "has whitespace"
        ),
        expected_field="prohibited_transitions[].sequence[].segment_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="segment::prohibited_transitions[].final_heading:required",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].final_heading", None),
        expected_field="prohibited_transitions[].final_heading",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].final_heading:enum",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].final_heading", "__INVALID__"),
        expected_field="prohibited_transitions[].final_heading",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].between:linear_range_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].between", [0.5]),
        expected_field="prohibited_transitions[].between",
        expected_check="linear_range_length",
    ),
    Scenario(
        id="segment::prohibited_transitions[].between:linear_range_bounds",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].between", [1.5, 2.0]),
        expected_field="prohibited_transitions[].between",
        expected_check="linear_range_bounds",
    ),
    Scenario(
        id="segment::prohibited_transitions[].between:linear_range_order",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].between", [0.8, 0.2]),
        expected_field="prohibited_transitions[].between",
        expected_check="linear_range_order",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.heading:enum",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].when.heading", "__INVALID__"),
        expected_field="prohibited_transitions[].when.heading",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.mode_min_length:array_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].when.mode", []),
        expected_field="prohibited_transitions[].when.mode_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
    ...
    Scenario(
        ...
        mutate=set_at_path("prohibited_transitions[].when.mode[]", "__INVALID__"),
        expected_field="prohibited_transitions[].when.mode[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.using_min_length:array_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].when.using", []),
        expected_field="prohibited_transitions[].when.using_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
    ...
    Scenario(
        ...
        mutate=set_at_path("prohibited_transitions[].when.using[]", "__INVALID__"),
        expected_field="prohibited_transitions[].when.using[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.recognized_min_length:array_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
    ...
    Scenario(
        ...
        mutate=set_at_path("prohibited_transitions[].when.recognized[]", "__INVALID__"),
        expected_field="prohibited_transitions[].when.recognized[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.vehicle_min_length:array_min_length",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
    ...
    Scenario(
        ...
        mutate=set_at_path("prohibited_transitions[].when.vehicle[].dimension", None),
        expected_field="prohibited_transitions[].when.vehicle[].dimension",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.vehicle[].dimension:enum",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path(
            "prohibited_transitions[].when.vehicle[].dimension", "__INVALID__"
        ),
        expected_field="prohibited_transitions[].when.vehicle[].dimension",
        expected_check="enum",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.vehicle[].comparison:required",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].when.vehicle[].comparison", None),
        expected_field="prohibited_transitions[].when.vehicle[].comparison",
        expected_check="required",
    ),
    Scenario(
        id="segment::prohibited_transitions[].when.vehicle[].comparison:enum",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path(
            "prohibited_transitions[].when.vehicle[].comparison", "__INVALID__"
        ),
        expected_field="prohibited_transitions[].when.vehicle[].comparison",
        expected_check="enum",
    ),
    ...
    Scenario(
        id="segment::prohibited_transitions[].when.vehicle[].value:bounds",
        scaffold={
            "prohibited_transitions": [
                {
                    "sequence": [{"connector_id": "a", "segment_id": "a"}],
        ...
        mutate=set_at_path("prohibited_transitions[].when.vehicle[].value", -1.0),
    ...
    Scenario(
        id="segment::road_flags_min_length:array_min_length",
        scaffold={"road_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("road_flags", []),
        expected_field="road_flags_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
    ...
    Scenario(
        ...
        expected_field="road_flags[].values",
        expected_check="required",
    ),
    Scenario(
        id="segment::road_flags[].values_min_length:array_min_length",
        scaffold={"road_flags": [{"values": ["is_bridge"]}]},
    ...
    Scenario(
        ...
        scaffold={"road_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("road_flags[].values[]", "__INVALID__"),
        expected_field="road_flags[].values[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::road_flags[].between:linear_range_length",
        scaffold={"road_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_flags[].between", [0.5]),
        expected_field="road_flags[].between",
        expected_check="linear_range_length",
    ),
    Scenario(
        id="segment::road_flags[].between:linear_range_bounds",
        scaffold={"road_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_flags[].between", [1.5, 2.0]),
        expected_field="road_flags[].between",
        expected_check="linear_range_bounds",
    ),
    Scenario(
        id="segment::road_flags[].between:linear_range_order",
        scaffold={"road_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_flags[].between", [0.8, 0.2]),
        expected_field="road_flags[].between",
        expected_check="linear_range_order",
    ),
    Scenario(
        id="segment::road_surface_min_length:array_min_length",
    ...
    Scenario(
        ...
        scaffold={"road_surface": [{"value": "unknown"}]},
        mutate=set_at_path("road_surface[].value", None),
        expected_field="road_surface[].value",
        expected_check="required",
    ),
    Scenario(
        id="segment::road_surface[].value:enum",
        scaffold={"road_surface": [{"value": "unknown"}]},
        mutate=set_at_path("road_surface[].value", "__INVALID__"),
        expected_field="road_surface[].value",
        expected_check="enum",
    ),
    Scenario(
        id="segment::road_surface[].between:linear_range_length",
        scaffold={"road_surface": [{"value": "unknown", "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_surface[].between", [0.5]),
        expected_field="road_surface[].between",
        expected_check="linear_range_length",
    ),
    Scenario(
        id="segment::road_surface[].between:linear_range_bounds",
        scaffold={"road_surface": [{"value": "unknown", "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_surface[].between", [1.5, 2.0]),
        expected_field="road_surface[].between",
        expected_check="linear_range_bounds",
    ),
    Scenario(
        id="segment::road_surface[].between:linear_range_order",
        scaffold={"road_surface": [{"value": "unknown", "between": [0.0, 1.0]}]},
        mutate=set_at_path("road_surface[].between", [0.8, 0.2]),
        expected_field="road_surface[].between",
        expected_check="linear_range_order",
    ),
    Scenario(
        id="segment::speed_limits_min_length:array_min_length",
    ...
    Scenario(
        id="segment::speed_limits[].max_speed.unit:required",
        scaffold={"speed_limits": [{"max_speed": {"value": 1, "unit": "mph"}}]},
        mutate=set_at_path("speed_limits[].max_speed.unit", None),
        expected_field="speed_limits[].max_speed.unit",
        expected_check="required",
    ),
    Scenario(
        id="segment::speed_limits[].max_speed.unit:enum",
        scaffold={"speed_limits": [{"max_speed": {"value": 1, "unit": "mph"}}]},
        mutate=set_at_path("speed_limits[].max_speed.unit", "__INVALID__"),
        expected_field="speed_limits[].max_speed.unit",
        expected_check="enum",
    ),
    Scenario(
    ...
    Scenario(
        id="segment::speed_limits[].when.vehicle_min_length:array_min_length",
        scaffold={
            "speed_limits": [
                {
                    "max_speed": {"value": 1, "unit": "mph"},
    ...
    Scenario(
        id="segment::subclass:enum",
        scaffold={"subclass": "link"},
        mutate=set_at_path("subclass", "__INVALID__"),
        expected_field="subclass",
        expected_check="enum",
    ),
    Scenario(
        id="segment::width_rules_min_length:array_min_length",
    ...
    Scenario(
        ...
        scaffold={"width_rules": [{"value": 1.0}]},
        mutate=set_at_path("width_rules[].value", None),
        expected_field="width_rules[].value",
        expected_check="required",
    ),
    Scenario(
        id="segment::width_rules[].value:bounds",
        scaffold={"width_rules": [{"value": 1.0}]},
        mutate=set_at_path("width_rules[].value", 0.0),
        expected_field="width_rules[].value",
        expected_check="bounds",
    ),
    Scenario(
        id="segment::width_rules[].between:linear_range_length",
        scaffold={"width_rules": [{"value": 1.0, "between": [0.0, 1.0]}]},
        mutate=set_at_path("width_rules[].between", [0.5]),
        expected_field="width_rules[].between",
        expected_check="linear_range_length",
    ),
    Scenario(
        id="segment::width_rules[].between:linear_range_bounds",
        scaffold={"width_rules": [{"value": 1.0, "between": [0.0, 1.0]}]},
        mutate=set_at_path("width_rules[].between", [1.5, 2.0]),
        expected_field="width_rules[].between",
        expected_check="linear_range_bounds",
    ),
    Scenario(
        id="segment::width_rules[].between:linear_range_order",
        scaffold={"width_rules": [{"value": 1.0, "between": [0.0, 1.0]}]},
        mutate=set_at_path("width_rules[].between", [0.8, 0.2]),
        expected_field="width_rules[].between",
        expected_check="linear_range_order",
    ),
    Scenario(
    ...
    Scenario(
        ...
        mutate=lambda row: mutate_forbid_if(
            ...
            "dimension",
            "axle_count",
            array_path="prohibited_transitions",
            inner_array_path="when.vehicle",
        ),
        expected_field="prohibited_transitions[].when.vehicle[].unit_forbidden",
        expected_check="forbid_if",
    ),
    Scenario(
        ...
        expected_field="prohibited_transitions[].when.vehicle[].unit_required_0",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="prohibited_transitions[].when.vehicle[].unit_required_1",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="prohibited_transitions[].when.vehicle[].unit_required_2",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="prohibited_transitions[].when.vehicle[].unit_required_3",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="prohibited_transitions[].when",
        expected_check="require_any_of",
    ),
    Scenario(
        ...
        mutate=lambda row: mutate_forbid_if(
            ...
            "dimension",
            "axle_count",
            array_path="speed_limits",
            inner_array_path="when.vehicle",
        ),
        expected_field="speed_limits[].when.vehicle[].unit_forbidden",
        expected_check="forbid_if",
    ),
    Scenario(
        ...
        expected_field="speed_limits[].when.vehicle[].unit_required_0",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="speed_limits[].when.vehicle[].unit_required_1",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="speed_limits[].when.vehicle[].unit_required_2",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="speed_limits[].when.vehicle[].unit_required_3",
        expected_check="require_if",
    ),
    Scenario(
        ...
        expected_field="speed_limits[].when",
        expected_check="require_any_of",
    ),
    Scenario(
        ...
        expected_field="speed_limits[]",
        expected_check="require_any_of",
    ),
    Scenario(
        id="segment::model:forbid_if:20",
        scaffold={},
    ...
    Scenario(
        id="segment::model:require_if:21",
        scaffold={},
    ...
    Scenario(
        id="segment::model:require_if:22",
        scaffold={},
