...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="connector::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="connector::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="connector::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="connector::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="connector::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="connector::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
