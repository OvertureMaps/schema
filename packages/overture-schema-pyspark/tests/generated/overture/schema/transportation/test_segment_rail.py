...
BASE_ROW_POPULATED: dict = {
    ...
    "class": "funicular",
    "rail_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}],
}
...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="segment::rail_flags_min_length:array_min_length",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("rail_flags", []),
        expected_field="rail_flags_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
        id="segment::rail_flags[].values:required",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("rail_flags[].values", None),
        expected_field="rail_flags[].values",
        expected_check="required",
    ),
    Scenario(
        id="segment::rail_flags[].values_min_length:array_min_length",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("rail_flags[].values", []),
        expected_field="rail_flags[].values_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
        id="segment::rail_flags[].values[]:enum",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=set_at_path("rail_flags[].values[]", "__INVALID__"),
        expected_field="rail_flags[].values[]",
        expected_check="enum",
    ),
    Scenario(
        id="segment::rail_flags[].between:linear_range_length",
        scaffold={"rail_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("rail_flags[].between", [0.5]),
        expected_field="rail_flags[].between",
        expected_check="linear_range_length",
    ),
    Scenario(
        id="segment::rail_flags[].between:linear_range_bounds",
        scaffold={"rail_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("rail_flags[].between", [1.5, 2.0]),
        expected_field="rail_flags[].between",
        expected_check="linear_range_bounds",
    ),
    Scenario(
        id="segment::rail_flags[].between:linear_range_order",
        scaffold={"rail_flags": [{"values": ["is_bridge"], "between": [0.0, 1.0]}]},
        mutate=set_at_path("rail_flags[].between", [0.8, 0.2]),
        expected_field="rail_flags[].between",
        expected_check="linear_range_order",
    ),
    Scenario(
    ...
    Scenario(
        id="segment::rail_flags_unique:struct_unique",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=lambda row: mutate_unique_items(row, "rail_flags"),
        expected_field="rail_flags_unique",
        expected_check="struct_unique",
    ),
    Scenario(
        id="segment::rail_flags[].values_unique:struct_unique",
        scaffold={"rail_flags": [{"values": ["is_bridge"]}]},
        mutate=lambda row: mutate_unique_items(row, "rail_flags[].values"),
        expected_field="rail_flags[].values_unique",
        expected_check="struct_unique",
    ),
]
