...
"""Generated conformance tests for building_part."""

from __future__ import annotations

import pytest
from overture.schema.pyspark.expressions.generated.overture.schema.buildings.building_part import (
    BUILDING_PART_SCHEMA,
    building_part_checks,
)
...
BASE_ROW_SPARSE: dict = {
    "id": "c039cf20-2e1c-5116-a393-4d834e447d46",
...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="building_part::id:string_min_length",
        scaffold={},
    ...
    Scenario(
        id="building_part::id:no_whitespace",
        scaffold={},
    ...
    Scenario(
        id="building_part::bbox:bbox_completeness",
    ...
    Scenario(
        id="building_part::bbox:bbox_lat_ordering",
        scaffold={"bbox": {"xmin": 0.0, "xmax": 1.0, "ymin": 0.0, "ymax": 1.0}},
        mutate=set_at_path(
    ...
    Scenario(
        id="building_part::bbox:bbox_lat_range",
        scaffold={"bbox": {"xmin": 0.0, "xmax": 1.0, "ymin": 0.0, "ymax": 1.0}},
        mutate=set_at_path(
    ...
    Scenario(
        id="building_part::geometry:required",
        scaffold={},
    ...
    Scenario(
        id="building_part::geometry:geometry_type",
        scaffold={},
    ...
    Scenario(
        id="building_part::theme:required",
        scaffold={},
    ...
    Scenario(
        id="building_part::type:required",
        scaffold={},
    ...
    Scenario(
        id="building_part::version:required",
        scaffold={},
    ...
    Scenario(
        id="building_part::version:bounds",
        scaffold={},
    ...
    Scenario(
        id="building_part::sources_min_length:array_min_length",
    ...
    Scenario(
        id="building_part::sources_unique:struct_unique",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="building_part::sources[].property:required",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="building_part::sources[].property:json_pointer",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="building_part::sources[].dataset:required",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="building_part::sources[].license:stripped",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="building_part::sources[].confidence_0:bounds",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="building_part::sources[].confidence_1:bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "confidence": 0.0}
            ]
    ...
    Scenario(
        id="building_part::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building_part::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="building_part::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building_part::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="building_part::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building_part::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
    ...
    Scenario(
        id="building_part::sources[].between:linear_range_length",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="building_part::sources[].between:linear_range_bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="building_part::sources[].between:linear_range_order",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="building_part::building_id:required",
        scaffold={},
        mutate=set_at_path("building_id", None),
        expected_field="building_id",
        expected_check="required",
    ),
    Scenario(
        id="building_part::building_id:string_min_length",
        scaffold={},
        mutate=set_at_path("building_id", ""),
        expected_field="building_id",
        expected_check="string_min_length",
    ),
    Scenario(
        id="building_part::building_id:no_whitespace",
        scaffold={},
        mutate=set_at_path("building_id", "has whitespace"),
        expected_field="building_id",
        expected_check="no_whitespace",
    ),
    Scenario(
        id="building_part::names.primary:required",
    ...
    Scenario(
        id="building_part::names.primary:string_min_length",
        scaffold={"names": {"primary": "a"}},
    ...
    Scenario(
        id="building_part::names.primary:stripped",
        scaffold={"names": {"primary": "a"}},
    ...
    Scenario(
        id="building_part::names.common{key}:language_tag",
    ...
    Scenario(
        id="building_part::names.common{value}:stripped",
        scaffold={"names": {"primary": "a", "common": {"en": "clean"}}},
    ...
    Scenario(
        id="building_part::names.rules[].value:required",
        scaffold={
    ...
    Scenario(
        id="building_part::names.rules[].value:string_min_length",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="building_part::names.rules[].value:stripped",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="building_part::names.rules[].variant:required",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="building_part::names.rules[].variant:enum",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="building_part::names.rules[].language:language_tag",
        scaffold={
            "names": {
                "primary": "a",
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.mode:required",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.mode:enum",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.countries:required",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.countries_min_length:array_min_length",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.countries_unique:struct_unique",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].perspectives.countries[]:country_code_alpha2",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="building_part::names.rules[].between:linear_range_length",
        scaffold={
            "names": {
                "primary": "a",
    ...
    Scenario(
        id="building_part::names.rules[].between:linear_range_bounds",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [{"value": "a", "variant": "common", "between": [0.0, 1.0]}],
    ...
    Scenario(
        id="building_part::names.rules[].between:linear_range_order",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [{"value": "a", "variant": "common", "between": [0.0, 1.0]}],
    ...
    Scenario(
        id="building_part::names.rules[].side:enum",
        scaffold={
            "names": {
                "primary": "a",
    ...
    Scenario(
        id="building_part::height:bounds",
        scaffold={"height": 1.0},
    ...
    Scenario(
        id="building_part::num_floors:bounds",
    ...
    Scenario(
        id="building_part::num_floors_underground:bounds",
    ...
    Scenario(
        id="building_part::min_floor:bounds",
    ...
    Scenario(
        id="building_part::facade_color:hex_color",
    ...
    Scenario(
        id="building_part::facade_material:enum",
    ...
    Scenario(
        id="building_part::roof_material:enum",
    ...
    Scenario(
        id="building_part::roof_shape:enum",
    ...
    Scenario(
        id="building_part::roof_direction_0:bounds",
    ...
    Scenario(
        id="building_part::roof_direction_1:bounds",
        scaffold={"roof_direction": 0.0},
    ...
    Scenario(
        id="building_part::roof_orientation:enum",
    ...
    Scenario(
        id="building_part::roof_color:hex_color",
...
def test_baseline_sparse(sparse_results: ValidationResults) -> None:
    ...
    scenario runs.
    """
    baseline = sparse_results.violations.get("building_part::baseline", set())
...
def test_baseline_populated(populated_results: ValidationResults) -> None:
    ...
    present.
    """
    baseline = populated_results.violations.get("building_part::baseline", set())
