...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="building::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="building::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="building::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="building::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
