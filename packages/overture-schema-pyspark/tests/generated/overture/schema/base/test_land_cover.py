...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="land_cover::sources[].confidence_0:bounds",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="land_cover::sources[].confidence_1:bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "confidence": 0.0}
            ]
    ...
    Scenario(
        id="land_cover::cartography.prominence_0:bounds",
    ...
    Scenario(
        id="land_cover::cartography.prominence_1:bounds",
        scaffold={"cartography": {"prominence": 1}},
    ...
    Scenario(
        id="land_cover::cartography.min_zoom_0:bounds",
    ...
    Scenario(
        id="land_cover::cartography.min_zoom_1:bounds",
        scaffold={"cartography": {"min_zoom": 0}},
    ...
    Scenario(
        id="land_cover::cartography.max_zoom_0:bounds",
    ...
    Scenario(
        id="land_cover::cartography.max_zoom_1:bounds",
        scaffold={"cartography": {"max_zoom": 0}},
