...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="land::sources[].confidence_0:bounds",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="land::sources[].confidence_1:bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "confidence": 0.0}
            ]
    ...
    Scenario(
        id="land::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="land::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="land::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="land::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="land::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="land::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
    ...
    Scenario(
        id="land::names.common{key}:language_tag",
    ...
    Scenario(
        id="land::names.common{value}:stripped",
        scaffold={"names": {"primary": "a", "common": {"en": "clean"}}},
