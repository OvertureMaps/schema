...
"""Generated conformance tests for water."""

from __future__ import annotations

import pytest
from overture.schema.pyspark.expressions.generated.overture.schema.base.water import (
    WATER_SCHEMA,
    water_checks,
)
...
BASE_ROW_SPARSE: dict = {
    "id": "a7a5e73a-79c0-55d7-ab4d-5f9fc65fe915",
...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="water::bbox:bbox_completeness",
    ...
    Scenario(
        id="water::bbox:bbox_lat_ordering",
        scaffold={"bbox": {"xmin": 0.0, "xmax": 1.0, "ymin": 0.0, "ymax": 1.0}},
        mutate=set_at_path(
    ...
    Scenario(
        id="water::geometry:geometry_type",
        scaffold={},
    ...
    Scenario(
        id="water::sources_min_length:array_min_length",
    ...
    Scenario(
        id="water::sources_unique:struct_unique",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="water::sources[].property:required",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="water::sources[].property:json_pointer",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="water::sources[].dataset:required",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="water::sources[].license:stripped",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="water::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="water::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="water::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="water::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="water::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="water::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
    ...
    Scenario(
        id="water::sources[].between:linear_range_length",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="water::sources[].between:linear_range_bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="water::sources[].between:linear_range_order",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="water::names.primary:string_min_length",
        scaffold={"names": {"primary": "a"}},
    ...
    Scenario(
        id="water::names.primary:stripped",
        scaffold={"names": {"primary": "a"}},
    ...
    Scenario(
        id="water::names.rules[].value:required",
        scaffold={
    ...
    Scenario(
        id="water::names.rules[].value:string_min_length",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="water::names.rules[].value:stripped",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="water::names.rules[].variant:required",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="water::names.rules[].variant:enum",
        scaffold={
            "names": {"primary": "a", "rules": [{"value": "a", "variant": "common"}]}
        },
    ...
    Scenario(
        id="water::names.rules[].language:language_tag",
        scaffold={
            "names": {
                "primary": "a",
    ...
    Scenario(
        id="water::names.rules[].perspectives.mode:required",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].perspectives.mode:enum",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].perspectives.countries:required",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].perspectives.countries_min_length:array_min_length",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].perspectives.countries_unique:struct_unique",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].perspectives.countries[]:country_code_alpha2",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [
    ...
    Scenario(
        id="water::names.rules[].between:linear_range_length",
        scaffold={
            "names": {
                "primary": "a",
    ...
    Scenario(
        id="water::names.rules[].between:linear_range_bounds",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [{"value": "a", "variant": "common", "between": [0.0, 1.0]}],
    ...
    Scenario(
        id="water::names.rules[].between:linear_range_order",
        scaffold={
            "names": {
                "primary": "a",
                "rules": [{"value": "a", "variant": "common", "between": [0.0, 1.0]}],
    ...
    Scenario(
        id="water::names.rules[].side:enum",
        scaffold={
            "names": {
                "primary": "a",
...
def test_baseline_sparse(sparse_results: ValidationResults) -> None:
    ...
    scenario runs.
    """
    baseline = sparse_results.violations.get("water::baseline", set())
...
def test_baseline_populated(populated_results: ValidationResults) -> None:
    ...
    present.
    """
    baseline = populated_results.violations.get("water::baseline", set())
