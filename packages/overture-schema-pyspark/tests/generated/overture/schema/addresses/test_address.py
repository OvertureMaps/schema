...
"""Generated conformance tests for address."""

from __future__ import annotations

import pytest
from overture.schema.pyspark.expressions.generated.overture.schema.addresses.address import (
    ADDRESS_SCHEMA,
    address_checks,
)
...
BASE_ROW_SPARSE: dict = {
    "id": "9b51bb94-b26f-5f88-ad00-affc1e8f1935",
    "geometry": "POINT (0 0)",
    "theme": "addresses",
    "type": "address",
    "version": 0,
...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="address::id:string_min_length",
        scaffold={},
    ...
    Scenario(
        id="address::bbox:bbox_completeness",
    ...
    Scenario(
        id="address::bbox:bbox_lat_ordering",
        scaffold={"bbox": {"xmin": 0.0, "xmax": 1.0, "ymin": 0.0, "ymax": 1.0}},
        mutate=set_at_path(
    ...
    Scenario(
        id="address::bbox:bbox_lat_range",
        scaffold={"bbox": {"xmin": 0.0, "xmax": 1.0, "ymin": 0.0, "ymax": 1.0}},
        mutate=set_at_path(
    ...
    Scenario(
        id="address::geometry:geometry_type",
        scaffold={},
    ...
    Scenario(
        id="address::sources_min_length:array_min_length",
    ...
    Scenario(
        id="address::sources[].property:json_pointer",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="address::sources[].dataset:required",
        scaffold={"sources": [{"property": "/valid/pointer", "dataset": ""}]},
    ...
    Scenario(
        id="address::sources[].license:stripped",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="address::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="address::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="address::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="address::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="address::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="address::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
    ...
    Scenario(
        id="address::sources[].between:linear_range_length",
        scaffold={
            "sources": [
    ...
    Scenario(
        id="address::sources[].between:linear_range_bounds",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="address::sources[].between:linear_range_order",
        scaffold={
            "sources": [
                {"property": "/valid/pointer", "dataset": "", "between": [0.0, 1.0]}
            ]
    ...
    Scenario(
        id="address::address_levels_min_length:array_min_length",
        scaffold={"address_levels": [{}]},
        mutate=set_at_path("address_levels", []),
        expected_field="address_levels_min_length",
        expected_check="array_min_length",
    ),
    Scenario(
        id="address::address_levels_max_length:array_max_length",
        scaffold={"address_levels": [{}]},
        mutate=set_at_path("address_levels", [{}, {}, {}, {}, {}, {}]),
    ...
    Scenario(
        id="address::address_levels[].value:string_min_length",
        scaffold={"address_levels": [{"value": "a"}]},
        mutate=set_at_path("address_levels[].value", ""),
        expected_field="address_levels[].value",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::address_levels[].value:stripped",
        scaffold={"address_levels": [{"value": "a"}]},
        mutate=set_at_path("address_levels[].value", " has spaces "),
        expected_field="address_levels[].value",
        expected_check="stripped",
    ),
    Scenario(
    ...
    Scenario(
        id="address::country:country_code_alpha2",
        scaffold={},
    ...
    Scenario(
        id="address::number:string_min_length",
        scaffold={"number": "a"},
        mutate=set_at_path("number", ""),
        expected_field="number",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::number:stripped",
        scaffold={"number": "a"},
        mutate=set_at_path("number", " has spaces "),
        expected_field="number",
        expected_check="stripped",
    ),
    Scenario(
        id="address::postal_city:string_min_length",
        scaffold={"postal_city": "a"},
        mutate=set_at_path("postal_city", ""),
        expected_field="postal_city",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::postal_city:stripped",
        scaffold={"postal_city": "a"},
        mutate=set_at_path("postal_city", " has spaces "),
        expected_field="postal_city",
        expected_check="stripped",
    ),
    Scenario(
        id="address::postcode:string_min_length",
        scaffold={"postcode": "a"},
        mutate=set_at_path("postcode", ""),
        expected_field="postcode",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::postcode:stripped",
        scaffold={"postcode": "a"},
        mutate=set_at_path("postcode", " has spaces "),
        expected_field="postcode",
        expected_check="stripped",
    ),
    Scenario(
        id="address::street:string_min_length",
        scaffold={"street": "a"},
        mutate=set_at_path("street", ""),
        expected_field="street",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::street:stripped",
        scaffold={"street": "a"},
        mutate=set_at_path("street", " has spaces "),
        expected_field="street",
        expected_check="stripped",
    ),
    Scenario(
        id="address::unit:string_min_length",
        scaffold={"unit": "a"},
        mutate=set_at_path("unit", ""),
        expected_field="unit",
        expected_check="string_min_length",
    ),
    Scenario(
        id="address::unit:stripped",
        scaffold={"unit": "a"},
        mutate=set_at_path("unit", " has spaces "),
        expected_field="unit",
        expected_check="stripped",
    ),
]
...
def test_baseline_sparse(sparse_results: ValidationResults) -> None:
    ...
    scenario runs.
    """
    baseline = sparse_results.violations.get("address::baseline", set())
...
def test_baseline_populated(populated_results: ValidationResults) -> None:
    ...
    present.
    """
    baseline = populated_results.violations.get("address::baseline", set())
