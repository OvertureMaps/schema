...
SCENARIOS: list[Scenario] = [
    ...
    Scenario(
        id="division::sources[].provider:string_min_length",
        scaffold={
    ...
    Scenario(
        id="division::sources[].provider:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "provider": "a"}]
        },
    ...
    Scenario(
        id="division::sources[].resource:string_min_length",
        scaffold={
    ...
    Scenario(
        id="division::sources[].resource:snake_case",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "resource": "a"}]
        },
    ...
    Scenario(
        id="division::sources[].version:string_min_length",
        scaffold={
    ...
    Scenario(
        id="division::sources[].version:no_whitespace",
        scaffold={
            "sources": [{"property": "/valid/pointer", "dataset": "", "version": "a"}]
        },
