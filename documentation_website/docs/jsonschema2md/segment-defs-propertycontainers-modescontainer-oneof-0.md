...
```txt
transportation/segment.yaml#/$defs/propertyContainers/modesContainer/oneOf/0
```
...
merged type ([Details](segment-defs-propertycontainers-modescontainer-oneof-0.md))
