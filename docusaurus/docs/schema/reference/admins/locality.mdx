...
Area polygons of localities, if known, are given by [locality area](/schema/reference/admins/locality_area) features.
...
[administrative boundary](/schema/reference/admins/administrative_boundary) features.
  </TabItem>
