...
Administrative boundaries are borders surrounding administrative [localities](/schema/reference/admins/locality).
...
between two administrative [localities](/schema/reference/admins/locality). In light of
