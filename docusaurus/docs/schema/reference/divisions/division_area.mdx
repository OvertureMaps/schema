...
A country is the largest unit of independent sovereignty. The border of a country, if known, is given by [boundary](/schema/reference/divisions/boundary) features. Example: United States
  </TabItem>
