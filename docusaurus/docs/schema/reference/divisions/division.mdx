...
The schema for the divisions theme contains an expanded list of subtypes, called placetypes, only a subset of which are available in the data. The subtypes currently available in the `division` feature type are: 
