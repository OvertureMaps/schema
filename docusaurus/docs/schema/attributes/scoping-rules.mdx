...
In the real-world, many facts and rules affecting entities have
...
vary according to the day of the week. <!-- add another example that is not transportation focused -->

The Overture Maps schema uses two related concepts to capture the partial application of facts and rules: scoped values, and rule-based properties.
...
[Shape and Connectivity](https://docs.overturemaps.org/guides/transportation/shape-connectivity).*) <!-- move shape and connectivity examples back to docs in schema repo-->
