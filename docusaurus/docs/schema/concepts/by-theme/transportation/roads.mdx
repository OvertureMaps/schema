...
Many transportation [use cases](/schema/concepts/by-theme/transportation#use-cases) can be solved either entirely or in large part without examining the lane
