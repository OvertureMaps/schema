...
- **[Names](/schema/properties/names)**: where applicable, complex propertoes such as names will always use the same schema across all themes.
- **[Scoped and rule-based properties](/schema/properties/scoping-rules)**: a scoping property narrows the scope of its parent property and may only apply to a particular instance of the parent property; rule-based property is an array of rules, which are objects containing at least one scoping property.
