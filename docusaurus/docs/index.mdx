...
- View the technical details and example implementations under [Schema Reference](reference)
...
2. We use GeoJSON as a mental model. We aim to deliver our data in the most developer-friendly formats. 
