...
The schema model for the Overture Maps transportation theme uses two related concepts to capture the partial application of
...
The Overture Maps transportation schema supports the following subjective factors:
...
To dive deeper into this topic, see the page on [travel modes](/guides/transportation/travel-modes).
...
and `backward` are defined on the [shape and connectivity](/guides/transportation/shape-connectivity) page.*)
