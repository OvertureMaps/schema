...
[Scoped and Rule-Based Properties](/overview/feature-model/scoping-rules) before proceeding
further.
...
[vehicle attributes scoping](/overview/feature-model/scoping-rules#vehicle-attributes-scoping).
