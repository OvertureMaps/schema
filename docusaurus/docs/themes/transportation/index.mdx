...
Overture Transportation theme describes the infrastructure and conventions of how
people and objects travel around the world. Transportation data includes
highways, footways, cycleways, railways, and ferry routes.

## Use Cases

todo. Specify the use cases that can be achieved with transportation data.

## Key Schema Design Choices

TODO: Things are allowed by default, except where explicitly prohibited.
...
- In general, the <code>at</code> property MAY contain either a single scalar number or a pair (two-entry array) of numbers.
...
[View the Schema for a Connector Type](/reference/transportation/connector)

[View the Schema for a Segment Type](/reference/transportation/segment)
