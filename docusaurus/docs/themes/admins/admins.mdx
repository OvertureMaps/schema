...
The current version of the schema does not support modeling of disputed boundaries or multiple geo-political views. In future schema versions, we will have support for:

1. Marking a boundary as disputed.
2. Providing multiple views of a country boundary based on the user's region.
3. Modeling the relationship between a country and its overseas territories (e.g., Puerto Rico) or other disputed territories (e.g., West Bank).
