...
Welcome to the Overture Maps Foundation's data documentation. Overture currently offer datasets across five themes -- **buildings, places, transportation, admin and base** -- with an easy-to-use and developer-friendly schema. 
...
- Reach out at [data@overturemaps.org](mailto:data@overturemaps.org) to discuss contributing your data to Overture.
...
- Consult the technical [reference](reference) for schema details.
- Learn about the [simple feature model](/overview/feature-model) we use to describe Overture data.
- Step through the mechanics of the [Global Entity Reference System (GERS)](../gers/gers.mdx).
