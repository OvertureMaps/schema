...
For example, here is a list of GERS IDs from Overture's recent release of buildings data, generated from a [query of GeoParquet file](https://github.com/OvertureMaps/data) using duckdb. 
