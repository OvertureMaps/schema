...
For Overture data layers which are ODbL, they must adhere to ODbL license terms, specifically whether any referenced data is considered a Collective Database or a Derivative Database. See
