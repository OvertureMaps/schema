...
import ExampleTurnRestriction from '!!raw-loader!@site/docs/_examples/transportation/docusaurus/turn-restriction.yaml';
...
<div display="display:hidden">
TODO: Remove wrapping hidden DIV and fix the link to Roads once that
page is active.
...
<Tabs>
  ...
  <TabItem value="turnRestrictions" label="Turn Restrictions" default>
    <CodeBlock language="json">{ JSON.stringify(yamlLoad(ExampleTurnRestriction), null, 2) }</CodeBlock>
  </TabItem>
</Tabs>
