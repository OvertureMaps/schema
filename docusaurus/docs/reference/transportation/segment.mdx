...
import ExampleTurnRestrictionSrc from '!!raw-loader!@site/docs/_examples/transportation/docusaurus/turn-restriction-source.yaml';
  ...
  <TabItem value="turnRestrictions" label="Turn Restrictions" default>
    <Tabs>
      <TabItem value="Source" label="Source" default>
        <CodeBlock language="json">{ JSON.stringify(yamlLoad(ExampleTurnRestrictionSrc), null, 2) }</CodeBlock>
      </TabItem>
      ...
      <TabItem value="Via" label="Via" default>
