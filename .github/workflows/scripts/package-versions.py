...
def compare(before_file: str, after_file: str):
    ...
    def level(package: str) -> int:
        ...
        if package == "overture-schema-system":
            ...
            return 1
        elif re.fullmatch(r'overture-schema-.*-theme', package) or package in ["overture-schema", "overture-schema-cli", "overture-schema-codegen", "overture-schema-annex", "overture-schema-pyspark"]:
            return 2
        else:
