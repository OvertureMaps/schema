        ...
        CAST(
            CASE
                ...
                WHEN tags['aeroway'] = 'aerodrome' THEN CASE
                    ...
                    WHEN tags['name'] LIKE '%municipal%' THEN ROW('airport','municipal_airport')
                    WHEN tags['name'] LIKE '%seaplane%' THEN ROW('airport','seaplane_airport')
                    WHEN tags['name'] LIKE '%heli%' THEN ROW('airport','heliport')
...
WHERE overture.subtype IS NOT NULL
