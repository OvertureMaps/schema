...
class TestUtils(unittest.TestCase):
    ...
    def test_get_intersecting_h3_cells_for_geo_json(self):
        ...
        line = { "type": "LineString", "coordinates": [[-83.61940200000001, 32.858034], [-83.61940200000001, 32.859538]] }
        actual_cells = get_intersecting_h3_cells_for_geo_json(line, 10)
        expected_cells = ["8a44c0a3295ffff", "8a44c0a32867fff"]
        self.assertCountEqual(actual_cells, expected_cells)

        polygon = { "type": "Polygon", "coordinates": [[[-83.6195695, 32.8591587], [-83.6192584, 32.8583723], [-83.619135, 32.8590437], [-83.6195695, 32.8591587]]] }
        ...
        ml = { "type": "MultiLineString", "coordinates": [[[-83.61940200000001, 32.858034], [-83.61940200000001, 32.859538]], [[-83.6215878, 32.8580366], [-83.6202145, 32.8580546]]] }
        actual_cells = get_intersecting_h3_cells_for_geo_json(ml, 10)
        expected_cells = ["8a44c0a3294ffff", "8a44c0a32867fff", "8a44c0a304b7fff", "8a44c0a3295ffff"]
        self.assertCountEqual(actual_cells, expected_cells)
