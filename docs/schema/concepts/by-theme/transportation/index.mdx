...
## Overview
The Overture transportation theme describes the infrastructure and conventions of how people and objects travel around the world. The schema defines a hierarchy of structures that attempt to make it easier to manage this complex dataset and reflect the operational reality of transportation networks. 

:::tip
For tips on accessing and working with our transportation data, please see our [Transportation Data Guide](/docs/guides/transportation). 
:::

The three subtypes under `segment` -- `road`, `rail`, and `water` -- contain most of the transportation data with which users are familiar: highways, footways, cycleways, railways, ferry routes, and public transportation. 
...
MOVE THESE UP TO CROSS-THEME CONCEPTS
