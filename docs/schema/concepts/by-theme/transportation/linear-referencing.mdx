...
If a consumer calculates linear references using planar distance while Overture uses geodetic distance, connector positions will be misaligned—potentially causing visual discrepancies on rendered maps or routing failures.
