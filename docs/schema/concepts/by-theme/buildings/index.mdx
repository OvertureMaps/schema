...
Both building and building_part types may have many **shape** related properties. These are useful for expressing the physical shape characteristics of the building including `roof_height`, `roof_shape`, `roof_material`, `facade_material`, etc.
...
<Tabs>
    ...
    <TabItem value="Metric">
        ...
        ```
        Height strings with a number followed by a metric unit that matches the singular
